...
if  input("Regenerate Fields?"):
    ...
    mtFields = np.diff(processData("2021-10-28_16-45-57_data_3rd round second with plate")[:, :, :, 1000:1500], axis=1) - np.diff(processData("2021-10-28_16-44-21_data_3rd round second run baseline")[:, :, :, 1000:1500], axis=1)
...
print(outputs)
plt.plot(np.arange(0, 5, .01,), outputs[0])
